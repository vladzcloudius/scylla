...
struct authorized_prepared_statements_cache_key {
public:
...
public:
    ...
    future<> insert(const auth::authenticated_user& user, const cql3::prepared_cache_key_type& prep_cache_key, value_type v) noexcept {
