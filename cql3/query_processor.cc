    ...
    , _prepared_cache(prep_cache_log)
{
    ...
    _metrics.add_group("cql", {
        ...
        sm::make_gauge("prepared_cache_entries_count", [this] { return _prepared_cache.entries_count(); },
                        sm::description("A number of entries in the prepared statements cache.")),

        sm::make_gauge("prepared_cache_entries_size", [this] { return _prepared_cache.size(); },
