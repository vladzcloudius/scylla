...
private:
    ...
    using cache_type = utils::loading_cache<cache_key_type, prepared_cache_entry, false, prepared_cache_entry_size, utils::tuple_hash, std::equal_to<cache_key_type>, prepared_cache_stats_updater>;
