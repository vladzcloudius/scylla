...
public:
    ...
    std::deque<wrapping_range<token>> ranges_compat() const {
    ...
    stream_request(sstring _keyspace, std::deque<wrapping_range<token>> _ranges, std::vector<sstring> _column_families)
