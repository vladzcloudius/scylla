...
private:
    ...
    size_t _current_buckets_count = InitialBucketsCount;
    set_type _set;
...
private:
    ...
    void rehash(size_t new_size) {
        ...
        if (ShrinkingIsAllowed && new_size < _current_buckets_count / 4) {
            new_buckets_count = _current_buckets_count / 2;
        } else if (new_size > 3 * _current_buckets_count / 4) {
            new_buckets_count = _current_buckets_count * 2;
        }
