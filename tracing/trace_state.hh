...
private:
    ...
    void init_session_records(trace_type type, std::chrono::seconds slow_query_ttl, std::experimental::optional<utils::UUID> session_id = std::experimental::nullopt, std::experimental::optional<span_id> parent_id = std::experimental::nullopt) {
        ...
        _records->parent_id = parent_id.value_or(_records->my_span_id);
    }
