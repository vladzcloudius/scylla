...
public:
    ...
    span_id(uint64_t id_) : id(id_) {}
    static inline span_id make_span_id();
};
...
span_id span_id::make_span_id() {
    return tracing::get_local_tracing_instance().get_next_rand_uint64();
}
}
