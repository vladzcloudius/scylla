...
public:
    typedef utils::loading_cache<std::pair<authenticated_user, data_resource>, permission_set, true, utils::simple_entry_size<permission_set>, utils::tuple_hash> cache_type;
