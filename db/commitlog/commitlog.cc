...
public:
    ...
    future<rp_handle>
    allocate_when_possible(const cf_id_type& id, shared_ptr<commitlog_entry_writer> writer, commitlog::timeout_clock::time_point timeout);
...
public:
     ...
     */
    future<rp_handle> allocate(const cf_id_type& id, shared_ptr<commitlog_entry_writer> writer, segment_manager::request_controller_units permit, commitlog::timeout_clock::time_point timeout) {
        if (must_sync()) {
...
future<db::rp_handle>
db::commitlog::segment_manager::allocate_when_possible(const cf_id_type& id, shared_ptr<commitlog_entry_writer> writer, commitlog::timeout_clock::time_point timeout) {
...
future<db::rp_handle> db::commitlog::add(const cf_id_type& id,
    ...
    class serializer_func_entry_writer final : public commitlog_entry_writer {
...
future<db::rp_handle> db::commitlog::add_entry(const cf_id_type& id, shared_ptr<db::commitlog_entry_writer> writer, timeout_clock::time_point timeout)
{
