        ...
        return _pending_ops.run_with_ordered_post_op(rp, [this, size, off, buf = std::move(buf)]() mutable { ///////////////////////////////////////////////////
            ...
            return do_with(off, view, [&] (uint64_t& off, fragmented_temporary_buffer::view& view) {
                ...
                return repeat([this, size, &off, &view] {
                    auto&& priority_class = _segment_manager->cfg.write_io_prio_class;
...
db::commitlog::read_log_file(const sstring& filename, commit_load_reader_func next, position_type off, const db::extensions* exts, seastar::io_priority_class read_io_prio_class) {
    struct work {
    private:
