...
private:
    ...
    public:
        ...
        public:
            ...
            /// \param drain drain all pending hints
            future<> stop(bool drain) noexcept;
    ...
    private:
        ...
        enum class state {
            ...
            draining,               // Drain hints for this end point
    ...
    public:
        ...
        ///
        /// If the current end_point_hints_manager is in the "draining" state - sends all pending hints out.
        ///
