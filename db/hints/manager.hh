...
private:
    ...
    private:
        static const std::chrono::minutes _column_mapping_cache_flush_period;
        ...
        timer_clock_type::time_point _last_columns_mapping_cache_flush_tp;
        int _replayed_segments_count = 0;
        seastar::gate _file_send_gate;
    ...
    public:
        ...
        bool store_hint(schema_ptr s, lw_shared_ptr<const frozen_mutation> fm, tracing::trace_state_ptr tr_state);
    ...
    private:
        ...
        future<> send_one_hint(temporary_buffer<char> buf, db::replay_position rp, gc_clock::duration secs_since_file_mod, const sstring& fname);
