...
private:
    ...
    public:
        ...
        using sender_clock = seastar::lowres_clock;
        ...
        private:
            ...
            state_set _state;
            promise<> _stopped;
            sender_clock::time_point _last_flush_tp;
        ...
        public:
            ...
            /// \brief Try to send out every hint we have.
            ///
            /// Flush hints aggregated to far to the storage every hints_flush_period.
            /// If the _segments_to_replay is not empty start sending.
            /// Will exit when stop() is called.
            void run();
        ...
        private:
            ...
            /// \return Ready future when operation is complete.
