...
private:
    ...
    private:
        ...
        future<> send_one_hint(temporary_buffer<char> buf, db::replay_position rp, gc_clock::duration secs_since_file_mod, const sstring& fname, seastar::gate& file_send_gate);
